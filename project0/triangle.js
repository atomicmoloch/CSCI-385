...
function populate() {
    triangle = new Triangle(0.0, 0.0, 1.0, 0.0);
    triangles.push(triangle);
    index = triangles.length-1;
    requestAnimationFrame(render);
    console.log("populating! " + triangles.length + " triangles");
}
...
function delete_tri() { //delete is reserved
    if (triangles.length > 1) {
        ...
        console.log("you cannot delete your only triangle!");
    }
}
